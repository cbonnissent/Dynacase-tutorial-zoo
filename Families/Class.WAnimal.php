...
namespace Zoo;
class WAnimal extends \Dcp\Family\WDoc
{
    var $attrPrefix = "WAN";
    ...
    function SendMailToVeto($newstate)
    {
        ...
        SetHttpVar("redirect_act", "CONFIRMMAIL&state=$newstate&ulink=Y&mzone=$zone&mail_to=$to&mail_format=html&mail_subject=$subject&mid=" . $this->doc->id);
